...
parser.add_argument('--sample_length', metavar='TOKENS', type=int, default=7, help='Sample this many tokens')
parser.add_argument('--sample_num', metavar='N', type=int, default=6, help='Generate this many samples')
...
def main():
    ...
    with tf.Session(config=config) as sess:
        ...
        def generate_samples():
            words = "ATP shall"
            context_tokens = enc.encode(words)
